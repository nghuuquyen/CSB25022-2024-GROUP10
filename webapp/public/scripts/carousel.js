document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listeners for slide controls if present
    ...
    document.querySelectorAll('.prev-best-seller-slide').forEach(button => {
        button.addEventListener('click', () => plusBestSellerSlides(-1));
    });

    document.querySelectorAll('.next-best-seller-slide').forEach(button => {
        button.addEventListener('click', () => plusBestSellerSlides(1));
    });
});
